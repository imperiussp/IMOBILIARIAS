...
export default function RegisterForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!fullName || !email || !password) return setStatus("Preencha nome, e-mail e senha.");
  ...
  return (
    <form className="loginCard" onSubmit={submit}>
      ...
      <button className="button primary full" type="submit" disabled={loading}>{loading ? "Criando..." : "Criar conta"}</button>
