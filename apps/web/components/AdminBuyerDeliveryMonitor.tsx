...
const eventLabels:Record<string,string>={historical_snapshot:"Estado anterior preservado",attempt_created:"Tentativa criada",provider_message_linked:"ID do provedor vinculado",status_sending:"Envio iniciado",status_sent:"Enviada",status_delivered:"Entregue",status_read:"Lida",status_failed:"Falha",status_cancelled:"Cancelada"};
