...
export default function PlatformPlanManager() {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    const features = {
      ...(editing?.features || {}),
      exclusive_site: form.get("exclusive_site") === "on",
      full_management: form.get("full_management") === "on",
      crm_real_estate: form.get("crm_real_estate") === "on",
  ...
  return <div className="adminPanel" id="planos-plataforma">
    ...
    <form className="propertyForm" onSubmit={save} key={editing?.id || "new"}>
      ...
      <fieldset className="featurePicker"><legend>Recursos principais</legend><div><label className="featureOption"><input type="checkbox" name="exclusive_site" defaultChecked={editing ? Boolean(editFeatures.exclusive_site) : true} /> Site exclusivo</label><label className="featureOption"><input type="checkbox" name="full_management" defaultChecked={editing ? Boolean(editFeatures.full_management) : true} /> Gestão completa</label><label className="featureOption"><input type="checkbox" name="broker_app" defaultChecked={editing ? Boolean(editFeatures.broker_app) : true} /> Aplicativo do corretor</label><label className="featureOption"><input type="checkbox" name="ai_buyer_outreach" defaultChecked={Boolean(editFeatures.ai_buyer_outreach)} /> IA de oportunidades</label><label className="featureOption"><input type="checkbox" name="crm_real_estate" defaultChecked={editing ? Boolean(editFeatures.crm_real_estate) : true} /> CRM imobiliário</label><label className="featureOption"><input type="checkbox" name="documents" defaultChecked={Boolean(editFeatures.documents)} /> Central de documentos</label></div></fieldset>
      <fieldset className="featurePicker"><legend>Recursos complementares</legend><div><label className="featureOption"><input type="checkbox" name="custom_domain" defaultChecked={Boolean(editFeatures.custom_domain)} /> Domínio próprio</label><label className="featureOption"><input type="checkbox" name="push_notifications" defaultChecked={Boolean(editFeatures.push_notifications)} /> Push no aplicativo</label><label className="featureOption"><input type="checkbox" name="email_leads" defaultChecked={Boolean(editFeatures.email_leads)} /> Contatos por e-mail</label><label className="featureOption"><input type="checkbox" name="ai_descriptions" defaultChecked={Boolean(editFeatures.ai_descriptions)} /> Descrições com IA</label><label className="featureOption"><input type="checkbox" name="default_trial" defaultChecked={Boolean(editFeatures.default_trial)} /> Plano padrão de teste</label></div></fieldset>
