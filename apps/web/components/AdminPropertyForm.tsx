...
export default function AdminPropertyForm() {
  ...
  return <form className="propertyForm mobilePropertyForm" onSubmit={submit}>
    ...
    <label>Endereço<input name="address" placeholder="Rua, número e complemento" /></label><label className="checkLabel"><input type="checkbox" name="address_public" /> Exibir endereço completo no site público</label>
