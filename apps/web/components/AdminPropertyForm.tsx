...
export default function AdminPropertyForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const payload = {
        ...
        address:String(form.get("address") || "").trim() || null, address_public:form.get("address_public") === "on", map_public:form.get("map_public") === "on", featured:form.get("featured") === "on",
  ...
  return <form className="propertyForm mobilePropertyForm" onSubmit={submit}>
    ...
    <div className="formGrid"><label className="checkLabel"><input type="checkbox" name="map_public" defaultChecked /> Exibir mapa no anúncio</label><label className="checkLabel"><input type="checkbox" name="address_public" /> Exibir endereço completo</label></div>
    <small className="formHint">O mapa fica visível por padrão. Desmarque “Exibir mapa no anúncio” somente quando quiser ocultá-lo. O endereço completo continua sendo uma opção separada.</small>
