...
export default function PublicHeader({ nested = false }: Props) {
  ...
  return <header className="topbar"><div className="container nav">
    ...
    <nav className="navLinks"><a href={`${prefix}#imoveis`}>Imóveis</a><a href={`${prefix}#como-funciona`}>Como funciona</a><a href={`${prefix}#contato`}>Contato</a><a href={`${prefix}admin/`}>Painel</a></nav>
    ...
    <details className="mobileMenu"><summary aria-label="Abrir menu">☰</summary><div><a href={`${prefix}#imoveis`}>Imóveis</a><a href={`${prefix}#como-funciona`}>Como funciona</a><a href={`${prefix}#contato`}>Contato</a><a href={`${prefix}admin/`}>Painel administrativo</a></div></details>
  </div></header>;
}
