...
const plans = [
  { name:"Start", featured:false, limits:["Até 30 imóveis","1 usuário","2 acessos simultâneos","1 e-mail profissional","5 fotos por imóvel"], features:["Site exclusivo","Catálogo de imóveis","CRM com funil de vendas","Leads via site e portais","WhatsApp flutuante no site","Site otimizado para SEO"], absent:["Aplicativo do corretor","IA de oportunidades","Central de documentos","Domínio próprio"] },
  ...
  { name:"Business", featured:false, limits:["Até 1.000 imóveis","Até 5 usuários","10 acessos simultâneos","5 e-mails profissionais","50 fotos por imóvel"], features:["Tudo do Pro","IA de oportunidades","Central de documentos","Gestão de vendas","Gestão de clientes","Permissões por usuário","Relatórios estratégicos","Reserva avançada de leads"], absent:[] },
  { name:"Prime", featured:false, limits:["Até 3.000 imóveis","Até 10 usuários","20 acessos simultâneos","10 e-mails profissionais","50 fotos por imóvel"], features:["Tudo do Business","Domínio próprio","Gestão multi-equipe","Maior capacidade de IA","Prioridade operacional","Recursos avançados de automação"], absent:[] },
];
