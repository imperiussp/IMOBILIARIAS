...
const sections = [
  ...
  ["Consentimentos", "#consentimento-compradores"],
  ["Oportunidades IA", "#oportunidades-ia"],
  ["Entregas IA", "#entregas-oportunidades"],
  ["Respostas IA", "#respostas-oportunidades"],
  ["Imóveis", "#imoveis"],
  ["Desempenho dos imóveis", "#desempenho-imoveis"],
  ["Ciclo dos imóveis", "#ciclo-imoveis"],
  ["Histórico de preços", "#historico-precos"],
  ["Documentação dos imóveis", "#documentacao-imovel"],
  ["Qualidade dos anúncios", "#qualidade-imoveis"],
  ["Novo imóvel", "#novo-imovel"],
  ["Descrição com IA", "#descricao-ia"],
  ["Localidades", "#localidades"],
  ["Tipos e recursos", "#catalogo-config"],
  ...
  ["Convites", "#convites"],
  ["Contatos", "#contatos"],
  ["Classificação", "#qualificacao-contatos"],
  ["Acompanhamentos", "#acompanhamentos"],
  ["Histórico do contato", "#historico-contato"],
  ["Documentos", "#documentos"],
  ["Anexos", "#arquivos-documentos"],
  ["Arquivos", "#arquivos"],
  ["Meu plano", "#meu-plano"],
  ["Pagamento", "#pagamento-infinitepay"],
  ["Imobiliária", "#configuracoes"],
  ["Domínios", "#dominios"],
  ["Histórico", "#historico"],
