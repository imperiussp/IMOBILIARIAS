...
const styles = StyleSheet.create({
  screen:{flex:1,backgroundColor:"#f4f6f8"},content:{padding:20,gap:18},header:{backgroundColor:"#17202a",borderRadius:24,padding:24,flexDirection:"row",justifyContent:"space-between",gap:16},kicker:{fontSize:12,fontWeight:"800",letterSpacing:2,color:"#aeb7c0"},title:{fontSize:32,lineHeight:36,fontWeight:"800",marginTop:10,color:"#fff"},text:{fontSize:15,lineHeight:22,marginTop:10,color:"#cbd2d8",maxWidth:260},syncBadge:{minWidth:82,alignSelf:"flex-start",backgroundColor:"#fff",borderRadius:18,padding:12,alignItems:"center"},syncNumber:{fontSize:26,fontWeight:"900",color:"#17202a"},syncLabel:{fontSize:10,color:"#69737d",textAlign:"center"},grid:{flexDirection:"row",flexWrap:"wrap",gap:12},primaryCard:{width:"48%",minHeight:160,backgroundColor:"#17202a",borderRadius:20,padding:20},card:{width:"48%",minHeight:160,backgroundColor:"#fff",borderRadius:20,padding:20},primaryCardIcon:{fontSize:30,color:"#fff"},primaryCardTitle:{fontSize:19,fontWeight:"800",color:"#fff",marginTop:22},primaryCardText:{fontSize:13,lineHeight:19,color:"#cbd2d8",marginTop:6},cardIcon:{fontSize:28,color:"#17202a"},cardTitle:{fontSize:18,fontWeight:"800",color:"#17202a",marginTop:22},cardText:{fontSize:13,lineHeight:19,color:"#68737e",marginTop:6},infoCard:{backgroundColor:"#fff",borderRadius:20,padding:20},infoTitle:{fontSize:18,fontWeight:"800",color:"#17202a"},infoText:{fontSize:14,lineHeight:22,color:"#65717c",marginTop:8},editorHeader:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:14},back:{fontSize:15,fontWeight:"800",color:"#5e6974"},editorTitle:{fontSize:24,fontWeight:"900",color:"#17202a"},formCard:{backgroundColor:"#fff",borderRadius:22,padding:20,gap:16},label:{fontSize:12,fontWeight:"800",color:"#56616c",marginBottom:7},groupTitle:{fontSize:12,fontWeight:"900",color:"#3f4b56",marginBottom:-8},help:{fontSize:11,color:"#85909a"},input:{borderWidth:1,borderColor:"#dce1e5",borderRadius:12,paddingHorizontal:14,paddingVertical:12,fontSize:15,color:"#17202a",backgroundColor:"#fff"},textarea:{minHeight:110},choiceRow:{flexDirection:"row",flexWrap:"wrap",gap:10},choiceWrap:{flexDirection:"row",flexWrap:"wrap",gap:8},choice:{paddingVertical:10,paddingHorizontal:14,borderRadius:999,borderWidth:1,borderColor:"#dce1e5",backgroundColor:"#fff"},choiceSelected:{backgroundColor:"#17202a",borderColor:"#17202a"},choiceText:{fontWeight:"800",color:"#56616c"},choiceTextSelected:{color:"#fff"},tripleRow:{flexDirection:"row",gap:9},miniField:{flex:1},photoHeader:{gap:10},photoActions:{flexDirection:"row",gap:8},smallAction:{backgroundColor:"#f1f4f6",borderRadius:10,paddingHorizontal:10,paddingVertical:9},photoStrip:{gap:10},photoItem:{width:120,height:110,borderRadius:14,overflow:"hidden",position:"relative",backgroundColor:"#eef1f3"},photo:{width:"100%",height:"100%"},removePhoto:{position:"absolute",right:5,top:5,width:26,height:26,borderRadius:13,backgroundColor:"rgba(23,32,42,.85)",alignItems:"center",justifyContent:"center"},removePhotoText:{color:"#fff",fontSize:20,lineHeight:21},coverLabel:{position:"absolute",left:6,bottom:6,backgroundColor:"#fff",paddingHorizontal:7,paddingVertical:4,borderRadius:7,fontSize:9,fontWeight:"900"},photoMove:{position:"absolute",right:5,bottom:5,flexDirection:"row",gap:4},photoMoveText:{backgroundColor:"rgba(255,255,255,.92)",paddingHorizontal:7,paddingVertical:4,borderRadius:7,fontWeight:"900"},secondaryButton:{minHeight:50,borderRadius:13,borderWidth:1,borderColor:"#ccd3d9",alignItems:"center",justifyContent:"center"},secondaryButtonText:{fontWeight:"900",color:"#17202a"},primaryButton:{minHeight:52,borderRadius:13,backgroundColor:"#17202a",alignItems:"center",justifyContent:"center"},primaryButtonText:{fontWeight:"900",color:"#fff"},disabled:{opacity:.5},draftCard:{backgroundColor:"#fff",borderRadius:18,padding:16,gap:12},draftInfo:{flexDirection:"row",alignItems:"center",gap:12},draftThumb:{width:64,height:54,borderRadius:10},draftTitle:{fontSize:17,fontWeight:"900",color:"#17202a"},draftMeta:{fontSize:12,color:"#76818b",marginTop:5},draftActions:{flexDirection:"row",gap:13,justifyContent:"flex-end"},editLink:{fontWeight:"800",color:"#245f9b"},deleteLink:{fontWeight:"800",color:"#a13b3b"},queueCard:{backgroundColor:"#fff",borderRadius:16,padding:16},queueHead:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:10},queueState:{fontSize:9,fontWeight:"900",backgroundColor:"#fff3c7",color:"#745d09",paddingHorizontal:8,paddingVertical:5,borderRadius:999},queueError:{backgroundColor:"#fff0f0",color:"#a13b3b"},errorText:{fontSize:12,lineHeight:18,color:"#a13b3b",marginTop:8},logoutButton:{minHeight:46,borderRadius:12,borderWidth:1,borderColor:"#d7dde2",alignItems:"center",justifyContent:"center"},logoutText:{fontWeight:"900",color:"#6b7580"}
});