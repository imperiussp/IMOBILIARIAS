...
begin
  ...
  if v_domain <> 'imoveis.lenoy.com.br' then
    if v_domain like '%.imoveis.lenoy.com.br' then
      raise exception 'Use @imoveis.lenoy.com.br ou um domínio próprio verificado';
    end if;
